...
const chamadosMock = [
  {
    id: 'TKT-001',
    titulo: 'Impressora do financeiro não funciona',
    status: 'Aberto',
    prioridade: 'Alta',
    usuario: 'Ana Silva',
  },
  ...
  {
    id: 'TKT-003',
    titulo: 'Solicitação de software (Photoshop)',
    status: 'Fechado',
    prioridade: 'Baixa',
    usuario: 'Carlos Dias',
  },
        ...
        <table className="min-w-full table-auto">
          ...
          <thead className="border-b border-border bg-background">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-sm font-semibold text-muted-foreground">Usuário</th>
              ...
              <tr key={chamado.id} className="hover:bg-background">
                ...
                <td className="px-4 py-3 text-sm">
                  <div className="flex items-center gap-3">
                    {/* Botão EDITAR leva para outra página, como o evandro pediu */}
                    <Link
